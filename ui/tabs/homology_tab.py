...
class HomologyTab(BaseTab):
    ...
    def _create_widgets(self):
        ...
        ttkb.Label(card1, text=_("源基因组:")).grid(row=0, column=0, padx=(10, 5), pady=10, sticky="w")
        ...
        ttkb.Label(card1, text=_("目标基因组:")).grid(row=1, column=0, padx=(10, 5), pady=10, sticky="w")
        ...
        ttkb.Label(card1, text=_("基因ID列表:")).grid(row=2, column=0, padx=(10, 5), pady=10, sticky="nw")
        ...
        def create_param_entry(p, label, default_val, r, c):
            ttkb.Label(p, text=label).grid(row=r, column=c * 2, padx=(10, 5), pady=5, sticky="w")
        ...
        ttkb.Label(card3, text=_("输出路径:")).grid(row=0, column=0, padx=(10, 5), pady=10, sticky="w")
