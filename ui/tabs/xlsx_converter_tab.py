...
class XlsxConverterTab(BaseTab):
    ...
    def _create_widgets(self):
        ...
        ttk.Label(main_card, text=_("输入Excel文件:"), font=self.app.app_font_bold).grid(row=0, column=0, padx=(10,5), pady=10, sticky="w")
        ...
        ttk.Label(main_card, text=_("输出CSV文件:"), font=self.app.app_font_bold).grid(row=1, column=0, padx=(10,5), pady=10, sticky="w")
